            ...
            <div class="content">
                ...
                <div class="stat">
                    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                        ...
                        <button class="go" type="submit" name="filter">Go</button>
                    </form>
                </div>
                                        ...
                                        <div class="btn">
                                            ...
                                            <div class="right">
                                                <form method="POST" action="editTask.php">
                                                    <a href="editTask.php?idtasks=<?php echo $task['idtasks']; ?>"
                                                        class="button-del">Edit</a>
